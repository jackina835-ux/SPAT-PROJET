...
/**
 * Points d'entree HTTP pour les commentaires.
 *
 * Droits appliques :
 *   consultation : tout utilisateur connecte
 *   redaction    : membre du projet (verifie dans le service)
 *   modification : auteur uniquement (verifie dans le service)
 *   suppression  : administrateur, auteur, ou chef du projet
 */
@RestController
...
public class CommentaireController {
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("@securite.estAuteurDuCommentaire(#id)")
    ...
    @PreAuthorize("hasRole('ADMIN') "
                + "or @securite.estAuteurDuCommentaire(#id) "
                + "or @securite.estResponsableDuProjetDuCommentaire(#id)")
